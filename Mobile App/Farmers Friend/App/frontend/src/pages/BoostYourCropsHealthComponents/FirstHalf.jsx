...
export const FirstHalf = ({ BoostYourCropsHealthStyle }) => {
  return (
    <View style={BoostYourCropsHealthStyle.firstHalfContainer}>
      {/* Components 1 */}
      <View style={BoostYourCropsHealthStyle.firstHalfChild}>
        <Svg
